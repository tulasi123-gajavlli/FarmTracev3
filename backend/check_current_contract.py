...
try:
    ...
    try:
        # Try to get product IDs array
        try:
            product_ids = contract.functions.productIds().call()
            print(f"Product IDs from contract: {product_ids}")
        except Exception as e:
            print(f"Could not get productIds: {e}")
